...
public class JsonRhymeList3 {
	...
	private List<JsonRhyme3> rhymes;

	public JsonRhymeList3(String version, String level, String turn, int turns) {
	...
	public List<JsonRhyme3> getRhymes() {
		return rhymes;
	}

	public void setRhymes(List<JsonRhyme3> rhymes) {
		this.rhymes = rhymes;
	}
	
	public void addRhyme(JsonRhyme3 jsonRhyme) {
