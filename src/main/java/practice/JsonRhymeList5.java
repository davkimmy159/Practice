...
public class JsonRhymeList5 {
	...
	private List<JsonRhyme5> rhymes;

	public JsonRhymeList5(String version, String level, String turn, int turns) {
	...
	public List<JsonRhyme5> getRhymes() {
		return rhymes;
	}

	public void setRhymes(List<JsonRhyme5> rhymes) {
		this.rhymes = rhymes;
	}
	
	public void addRhyme(JsonRhyme5 jsonRhyme) {
